    ...
    <div className="space-y-10">
      <section className="overflow-hidden rounded-3xl border border-[var(--border)] bg-[var(--card)] px-6 py-12 sm:px-10">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-relaxed text-[var(--muted)]">
          Short practice modules on prompt briefs, launch JWT trust, event telemetry, and suite thinking —
          inspired by tight practice loops, instrumented for Ludwitt. Counted learning sessions start from the
          Ludwitt launcher, not a cold visit to this marketing page.
        </p>
        <div className="mt-8 flex flex-wrap gap-3">
          {listing ? (
            ...
            <span className="rounded-full border border-[var(--border)] px-5 py-2.5 text-sm text-[var(--muted)]">
              Ludwitt listing URL pending registration
            </span>
          )}
          <Link
            href="/learn"
